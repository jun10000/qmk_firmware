...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//|--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------|
		_______,   KC_NO, KC_HOME,   KC_UP,  KC_END,   KC_NO,                     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
	//|--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------|
	...
	//|--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------|
		_______,  KC_F11,  KC_F12,   SSHOT,   KC_NO,   KC_NO,                     KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
	//|--------+--------+--------+--------+--------+--------|                 |--------+--------+--------+--------+--------+--------|
		  KC_NO,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,   KC_NO,
	//|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
		_______,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_DOT,   KC_NO, _______,
	//`--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
		                  _______, _______, DEFAULT, _______, _______, _______, _______, DEFAULT, _______, _______
	//                  `--------+--------+--------+--------+--------+--------+--------+--------+--------+--------'
	),
...
const rgblight_segment_t PROGMEM my_rgb_layer0[] = RGBLIGHT_LAYER_SEGMENTS({0, RGBLED_COUNT, HSV_WHITE2});
const rgblight_segment_t PROGMEM my_rgb_layer1[] = RGBLIGHT_LAYER_SEGMENTS({0, RGBLED_COUNT, HSV_GREEN2});
const rgblight_segment_t PROGMEM my_rgb_layer2[] = RGBLIGHT_LAYER_SEGMENTS({0, RGBLED_COUNT, HSV_YELLOW2});
const rgblight_segment_t PROGMEM my_rgb_layer3[] = RGBLIGHT_LAYER_SEGMENTS({0, RGBLED_COUNT, HSV_RED2});
